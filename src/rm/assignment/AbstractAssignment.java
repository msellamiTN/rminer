...
// Source File Name:   AbstractAssignment.java
...
public abstract class AbstractAssignment
    implements Cloneable, Assignment, Serializable, CapabilitiesHandler
{
    ...
    public static Assignment forName(String assigersName, String options[])
        throws Exception
    {
        return (Assignment)Utils.forName(Assignment.class, assigersName, options);
    //    0    0:ldc1            #8   <Class Assignment>
    //    1    2:aload_0         
    //    2    3:aload_1         
    //    3    4:invokestatic    #33  <Method Object Utils.forName(Class, String, String[])>
    //    4    7:checkcast       #8   <Class Assignment>
    //    5   10:areturn         
    }

    public static Assignment makeCopy(Assignment model)
        throws Exception
    {
        return (Assignment)(new SerializedObject(model)).getObject();
    ...
    //    5   11:checkcast       #8   <Class Assignment>
    //    6   14:areturn         
    }

    public static Assignment[] makeCopies(Assignment model, int num)
        throws Exception
    {
        if(model == null)
    //*   0    0:aload_0         
    ...
    //    3    7:dup             
    //    4    8:ldc1            #54  <String "No model assigors set">
    //    5   10:invokespecial   #57  <Method void Exception(String)>
    //    6   13:athrow          
        Assignment assigors[] = new Assignment[num];
    //    7   14:iload_1         
    //    8   15:anewarray       Assignment[]
    //    9   18:astore_2        
    ...
    //   14   27:astore_3        
        for(int i = 0; i < assigors.length; i++)
    //*  15   28:iconst_0        
    //*  16   29:istore          4
    //*  17   31:goto            48
            assigors[i] = (Assignment)so.getObject();
    //   18   34:aload_2         
    //   19   35:iload           4
    //   20   37:aload_3         
    //   21   38:invokevirtual   #48  <Method Object SerializedObject.getObject()>
    //   22   41:checkcast       #8   <Class Assignment>
    //   23   44:aastore         
    ...
    protected static void runAssiger(Assignment assiger, String options[])
    {
        try
        {
            System.out.println(AssignmentEvaluation.evaluate(assiger, options));
    //    0    0:getstatic       #84  <Field PrintStream System.out>
    //    1    3:aload_0         
    //    2    4:aload_1         
    //    3    5:invokestatic    #90  <Method String AssignmentEvaluation.evaluate(Assignment, String[])>
